...
#加载模型
net_a=torch.load('./Zhang-s-Sisters/model_a.pkl',map_location=lambda storage, loc: storage)
net_b=torch.load('./Zhang-s-Sisters/model_b.pkl',map_location=lambda storage, loc: storage)
net_c=torch.load('./Zhang-s-Sisters/model_c.pkl',map_location=lambda storage, loc: storage)
net_d=torch.load('./Zhang-s-Sisters/model_d.pkl',map_location=lambda storage, loc: storage)
net_e=torch.load('./Zhang-s-Sisters/model_e.pkl',map_location=lambda storage, loc: storage)
net_f=torch.load('./Zhang-s-Sisters/model_f.pkl',map_location=lambda storage, loc: storage)
net_g=torch.load('./Zhang-s-Sisters/model_g.pkl',map_location=lambda storage, loc: storage)
net_h=torch.load('./Zhang-s-Sisters/model_h.pkl',map_location=lambda storage, loc: storage)
net_i=torch.load('./Zhang-s-Sisters/model_i.pkl',map_location=lambda storage, loc: storage)
net_j=torch.load('./Zhang-s-Sisters/model_j.pkl',map_location=lambda storage, loc: storage)
net_k=torch.load('./Zhang-s-Sisters/model_k.pkl',map_location=lambda storage, loc: storage)
net_l=torch.load('./Zhang-s-Sisters/model_l.pkl',map_location=lambda storage, loc: storage)
